      ...
      <div className="overview-grid-top">
        ...
        <div className="overview-card punch-card">
          ...
          <div className="punch-timer">
            ...
            {isCheckedOut && (
              <>
                <span className="timer-value">{todayStatus?.record?.status || 'Completed'}</span>
                <span className="timer-since">Completed for today ({formatTime(checkInTime)} - {todayStatus?.record?.checkOut || 'N/A'})</span>
              </>
            )}
          ...
          <div className="punch-actions">
            {isCheckedOut ? (
              <span className="punch-completed-text">
